...
#
# Script generated by Vivado on Wed Oct 09 18:02:36 EDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : position_ram.sh
...
#
# Usage        : position_ram.sh
#                position_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                position_ram.sh [-reset_run]
#                position_ram.sh [-reset_log]
#                position_ram.sh [-help]
#
...
#                script (type 'position_ram.sh -help' for more information).
#
...
# script info
echo -e "position_ram.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./position_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.position_ram xil_defaultlib.glbl -o position_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./position_ram_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/landaud1/other/Senior_proj/Physics-Gpu-2025/Master/Physics-GPU-2025/Physics-GPU-2025.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key position_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc position_ram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./position_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: position_ram.sh [-help]\n\
Usage: position_ram.sh [-step]\n\
Usage: position_ram.sh [-lib_map_path]\n\
Usage: position_ram.sh [-reset_run]\n\
Usage: position_ram.sh [-reset_log]\n\
Usage: position_ram.sh [-keep_index]\n\
Usage: position_ram.sh [-noclean_files]\n\n\
