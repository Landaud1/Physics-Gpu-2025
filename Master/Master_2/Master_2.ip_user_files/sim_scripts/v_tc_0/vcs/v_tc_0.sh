...
design_libs=(xpm axi_lite_ipif_v3_0_4 v_tc_v6_2_8 xil_defaultlib)
...
reset_run()
{
  files_to_remove=(ucli.key v_tc_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc v_tc_0_simv.daidir vcs_lib c.obj)
