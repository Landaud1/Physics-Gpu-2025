...
#
# Script generated by Vivado on Mon Apr 07 12:07:43 EDT 2025
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : float_gt.sh
...
#
# Usage        : float_gt.sh
#                float_gt.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                float_gt.sh [-reset_run]
#                float_gt.sh [-reset_log]
#                float_gt.sh [-help]
#
...
#                script (type 'float_gt.sh -help' for more information).
#
...
# script info
echo -e "float_gt.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./float_gt.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.float_gt xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.float_gt -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/landaud1/other/Senior_proj/Physics-Gpu-2025/Master/Master_2/Master_2.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log float_gt_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./float_gt.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: float_gt.sh [-help]\n\
Usage: float_gt.sh [-step]\n\
Usage: float_gt.sh [-lib_map_path]\n\
Usage: float_gt.sh [-reset_run]\n\
Usage: float_gt.sh [-reset_log]\n\
Usage: float_gt.sh [-keep_index]\n\
Usage: float_gt.sh [-noclean_files]\n\n\
