...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.float_gt xil_defaultlib.glbl -o float_gt_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./float_gt_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/landaud1/other/Senior_proj/Physics-Gpu-2025/Master/Master_2/Master_2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key float_gt_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc float_gt_simv.daidir vcs_lib c.obj)
