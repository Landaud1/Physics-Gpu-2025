...
//    end
    ...
    assign sr_write = (sum_calc_mode == `scm_acc) ? 0 :
                      (sum_calc_mode == `scm_pos) ? {192'b0, mass, vy, vx, sum_ram_read_data[127:64], sum_ram_read_data[63:0]} :           
                      (sum_calc_mode == `scm_vel) ? {192'b0, mass, sum_ram_read_data[127:64], sum_ram_read_data[63:0], y, x} :         
                      0;
