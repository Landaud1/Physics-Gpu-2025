...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L axi_lite_ipif_v3_0_4 -L v_tc_v6_2_8 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot v_tc_0 xil_defaultlib.v_tc_0 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb v_tc_0.wdb xsim.dir libdpi.so)
