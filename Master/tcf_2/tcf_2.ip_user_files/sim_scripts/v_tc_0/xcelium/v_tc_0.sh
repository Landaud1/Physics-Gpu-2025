...
#
# Script generated by Vivado on Fri Mar 28 12:20:15 EDT 2025
...
#
# Usage        : v_tc_0.sh
#                v_tc_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                v_tc_0.sh [-reset_run]
#                v_tc_0.sh [-reset_log]
#                v_tc_0.sh [-help]
#
...
#                script (type 'v_tc_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname axi_lite_ipif_v3_0_4 -libname v_tc_v6_2_8 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm axi_lite_ipif_v3_0_4 v_tc_v6_2_8 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "v_tc_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./v_tc_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.v_tc_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.v_tc_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log v_tc_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: v_tc_0.sh [-step]\n\
Usage: v_tc_0.sh [-lib_map_path]\n\
Usage: v_tc_0.sh [-reset_run]\n\
Usage: v_tc_0.sh [-reset_log]\n\
Usage: v_tc_0.sh [-keep_index]\n\
