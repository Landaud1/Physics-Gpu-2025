...
#
# Script generated by Vivado on Tue Oct 15 20:29:25 EDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fp_reciprocal.sh
...
#
# Usage        : fp_reciprocal.sh
#                fp_reciprocal.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp_reciprocal.sh [-reset_run]
#                fp_reciprocal.sh [-reset_log]
#                fp_reciprocal.sh [-help]
#
...
#                script (type 'fp_reciprocal.sh -help' for more information).
#
...
design_libs=(simprims_ver xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_1_18 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fp_reciprocal.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp_reciprocal.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fp_reciprocal xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fp_reciprocal -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fp_reciprocal_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fp_reciprocal.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fp_reciprocal.sh [-help]\n\
Usage: fp_reciprocal.sh [-step]\n\
Usage: fp_reciprocal.sh [-lib_map_path]\n\
Usage: fp_reciprocal.sh [-reset_run]\n\
Usage: fp_reciprocal.sh [-reset_log]\n\
Usage: fp_reciprocal.sh [-keep_index]\n\
Usage: fp_reciprocal.sh [-noclean_files]\n\n\
