...
design_libs=(xpm xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_1_18 xil_defaultlib)
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_reciprocal xil_defaultlib.glbl -o fp_reciprocal_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp_reciprocal_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fp_reciprocal_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fp_reciprocal_simv.daidir vcs_lib c.obj)
