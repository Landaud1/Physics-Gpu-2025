...
#
# Script generated by Vivado on Wed Oct 09 17:25:25 EDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fp_multiply.sh
...
#
# Usage        : fp_multiply.sh
#                fp_multiply.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp_multiply.sh [-reset_run]
#                fp_multiply.sh [-reset_log]
#                fp_multiply.sh [-help]
#
...
#                script (type 'fp_multiply.sh -help' for more information).
#
...
# script info
echo -e "fp_multiply.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp_multiply.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fp_multiply xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fp_multiply -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fp_multiply_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fp_multiply.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fp_multiply.sh [-help]\n\
Usage: fp_multiply.sh [-step]\n\
Usage: fp_multiply.sh [-lib_map_path]\n\
Usage: fp_multiply.sh [-reset_run]\n\
Usage: fp_multiply.sh [-reset_log]\n\
Usage: fp_multiply.sh [-keep_index]\n\
Usage: fp_multiply.sh [-noclean_files]\n\n\
