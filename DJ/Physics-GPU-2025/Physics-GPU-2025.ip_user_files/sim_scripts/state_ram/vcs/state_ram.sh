...
#
# Script generated by Vivado on Thu Sep 26 17:44:02 EDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : state_ram.sh
...
#
# Usage        : state_ram.sh
#                state_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                state_ram.sh [-reset_run]
#                state_ram.sh [-reset_log]
#                state_ram.sh [-help]
#
...
#                script (type 'state_ram.sh -help' for more information).
#
...
# script info
echo -e "state_ram.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./state_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.state_ram xil_defaultlib.glbl -o state_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./state_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key state_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc state_ram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./state_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: state_ram.sh [-help]\n\
Usage: state_ram.sh [-step]\n\
Usage: state_ram.sh [-lib_map_path]\n\
Usage: state_ram.sh [-reset_run]\n\
Usage: state_ram.sh [-reset_log]\n\
Usage: state_ram.sh [-keep_index]\n\
Usage: state_ram.sh [-noclean_files]\n\n\
