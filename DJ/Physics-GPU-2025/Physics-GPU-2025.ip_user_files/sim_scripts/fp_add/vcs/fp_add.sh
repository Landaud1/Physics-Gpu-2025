...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_add xil_defaultlib.glbl -o fp_add_simv
}
...
reset_run()
{
  files_to_remove=(ucli.key fp_add_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fp_add_simv.daidir vcs_lib c.obj)
