...
#
# Script generated by Vivado on Wed Oct 09 17:24:22 EDT 2024
...
#
# Usage        : fp_add.sh
#                fp_add.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp_add.sh [-reset_run]
#                fp_add.sh [-reset_log]
#                fp_add.sh [-help]
#
...
#                script (type 'fp_add.sh -help' for more information).
#
...
# script info
echo -e "fp_add.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp_add.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fp_add xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fp_add -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fp_add_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fp_add.sh [-step]\n\
Usage: fp_add.sh [-lib_map_path]\n\
Usage: fp_add.sh [-reset_run]\n\
Usage: fp_add.sh [-reset_log]\n\
Usage: fp_add.sh [-keep_index]\n\
