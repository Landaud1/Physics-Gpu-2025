...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fp_sqrt xil_defaultlib.glbl -o fp_sqrt_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fp_sqrt_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fp_sqrt_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fp_sqrt_simv.daidir vcs_lib c.obj)
