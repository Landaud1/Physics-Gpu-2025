...
#
# Script generated by Vivado on Tue Oct 15 20:30:47 EDT 2024
...
#
# Usage        : fp_sqrt.sh
#                fp_sqrt.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fp_sqrt.sh [-reset_run]
#                fp_sqrt.sh [-reset_log]
#                fp_sqrt.sh [-help]
#
...
#                script (type 'fp_sqrt.sh -help' for more information).
#
...
# script info
echo -e "fp_sqrt.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fp_sqrt.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fp_sqrt xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fp_sqrt -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fp_sqrt_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fp_sqrt.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fp_sqrt.sh [-help]\n\
Usage: fp_sqrt.sh [-step]\n\
Usage: fp_sqrt.sh [-lib_map_path]\n\
Usage: fp_sqrt.sh [-reset_run]\n\
Usage: fp_sqrt.sh [-reset_log]\n\
Usage: fp_sqrt.sh [-keep_index]\n\
Usage: fp_sqrt.sh [-noclean_files]\n\n\
