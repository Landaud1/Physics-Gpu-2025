...
#
# Script generated by Vivado on Wed Oct 23 17:25:48 EDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : float_to_fixed.sh
...
#
# Usage        : float_to_fixed.sh
#                float_to_fixed.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                float_to_fixed.sh [-reset_run]
#                float_to_fixed.sh [-reset_log]
#                float_to_fixed.sh [-help]
#
...
#                script (type 'float_to_fixed.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_13 -libname axi_utils_v2_0_9 -libname xbip_pipe_v3_0_9 -libname xbip_dsp48_wrapper_v3_0_6 -libname xbip_dsp48_addsub_v3_0_9 -libname xbip_dsp48_multadd_v3_0_9 -libname xbip_bram18k_v3_0_9 -libname mult_gen_v12_0_21 -libname floating_point_v7_1_18 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_1_18 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "float_to_fixed.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./float_to_fixed.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work floating_point_v7_1_18 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.float_to_fixed xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.float_to_fixed -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/landaud1/other/Senior_proj/Physics-Gpu-2025/DJ/Physics-GPU-2025/Physics-GPU-2025.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log float_to_fixed_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./float_to_fixed.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: float_to_fixed.sh [-help]\n\
Usage: float_to_fixed.sh [-step]\n\
Usage: float_to_fixed.sh [-lib_map_path]\n\
Usage: float_to_fixed.sh [-reset_run]\n\
Usage: float_to_fixed.sh [-reset_log]\n\
Usage: float_to_fixed.sh [-keep_index]\n\
Usage: float_to_fixed.sh [-noclean_files]\n\n\
