...
design_libs=(xbip_utils_v3_0_13 axi_utils_v2_0_9 xbip_pipe_v3_0_9 xbip_dsp48_wrapper_v3_0_6 xbip_dsp48_addsub_v3_0_9 xbip_dsp48_multadd_v3_0_9 xbip_bram18k_v3_0_9 mult_gen_v12_0_21 floating_point_v7_1_18 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work floating_point_v7_1_18 $vlogan_opts +v2k \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.float_to_fixed xil_defaultlib.glbl -o float_to_fixed_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./float_to_fixed_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/landaud1/other/Senior_proj/Physics-Gpu-2025/DJ/Physics-GPU-2025/Physics-GPU-2025.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key float_to_fixed_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc float_to_fixed_simv.daidir vcs_lib c.obj)
