...
#
# Script generated by Vivado on Wed Nov 13 17:17:42 EST 2024
...
#
# Usage        : pe_ram.sh
#                pe_ram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                pe_ram.sh [-reset_run]
#                pe_ram.sh [-reset_log]
#                pe_ram.sh [-help]
#
...
#                script (type 'pe_ram.sh -help' for more information).
#
...
# script info
echo -e "pe_ram.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./pe_ram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.pe_ram xil_defaultlib.glbl -o pe_ram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./pe_ram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key pe_ram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc pe_ram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./pe_ram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: pe_ram.sh [-help]\n\
Usage: pe_ram.sh [-step]\n\
Usage: pe_ram.sh [-lib_map_path]\n\
Usage: pe_ram.sh [-reset_run]\n\
Usage: pe_ram.sh [-reset_log]\n\
Usage: pe_ram.sh [-keep_index]\n\
Usage: pe_ram.sh [-noclean_files]\n\n\
