...
#
# Script generated by Vivado on Tue Oct 22 14:26:57 EDT 2024
# SW Build 5076996 on Wed May 22 18:36:09 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : simple_33_x_10_ABRAM.sh
...
#
# Usage        : simple_33_x_10_ABRAM.sh
#                simple_33_x_10_ABRAM.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                simple_33_x_10_ABRAM.sh [-reset_run]
#                simple_33_x_10_ABRAM.sh [-reset_log]
#                simple_33_x_10_ABRAM.sh [-help]
#
...
#                script (type 'simple_33_x_10_ABRAM.sh -help' for more information).
#
...
# script info
echo -e "simple_33_x_10_ABRAM.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./simple_33_x_10_ABRAM.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.simple_33_x_10_ABRAM xil_defaultlib.glbl -o simple_33_x_10_ABRAM_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./simple_33_x_10_ABRAM_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/drive/sda2/home/aldridf1/Senior_Project_2024/Physics-Gpu-2025/Francis/sp_gram_test_1/sp_gram_test_1.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key simple_33_x_10_ABRAM_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc simple_33_x_10_ABRAM_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./simple_33_x_10_ABRAM.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: simple_33_x_10_ABRAM.sh [-help]\n\
Usage: simple_33_x_10_ABRAM.sh [-step]\n\
Usage: simple_33_x_10_ABRAM.sh [-lib_map_path]\n\
Usage: simple_33_x_10_ABRAM.sh [-reset_run]\n\
Usage: simple_33_x_10_ABRAM.sh [-reset_log]\n\
Usage: simple_33_x_10_ABRAM.sh [-keep_index]\n\
Usage: simple_33_x_10_ABRAM.sh [-noclean_files]\n\n\
