...
#
# Script generated by Vivado on Wed Nov 20 17:33:43 EST 2024
...
#
# Usage        : gram.sh
#                gram.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gram.sh [-reset_run]
#                gram.sh [-reset_log]
#                gram.sh [-help]
#
...
#                script (type 'gram.sh -help' for more information).
#
...
# script info
echo -e "gram.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gram.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.gram xil_defaultlib.glbl -o gram_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./gram_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key gram_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc gram_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gram.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gram.sh [-help]\n\
Usage: gram.sh [-step]\n\
Usage: gram.sh [-lib_map_path]\n\
Usage: gram.sh [-reset_run]\n\
Usage: gram.sh [-reset_log]\n\
Usage: gram.sh [-keep_index]\n\
Usage: gram.sh [-noclean_files]\n\n\
